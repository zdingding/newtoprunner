...
public class LoginView extends RelativeLayout  {
	...
	private void init(Context context) {
		...
		LinearLayout ll_login_qq = (LinearLayout) view.findViewById(R.id.ll_login_qq);
		LinearLayout ll_login_sina = (LinearLayout) view.findViewById(R.id.ll_login_sina);
		...
		ll_login_qq.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Toast.makeText(UIUtils.getContext(),"使用QQ登录",Toast.LENGTH_SHORT).show();
				Platform wechat = ShareSDK.getPlatform(Wechat.NAME);
				authorize(wechat);
			}
		});
		ll_login_sina.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Toast.makeText(UIUtils.getContext(),"使用新浪登录",Toast.LENGTH_SHORT).show();
			}
		});
