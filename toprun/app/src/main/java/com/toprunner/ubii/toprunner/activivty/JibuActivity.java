...
import com.toprunner.ubii.toprunner.service.StepService;
import com.toprunner.ubii.toprunner.utils.CacheUtils;
import com.toprunner.ubii.toprunner.utils.ConfigUtil;
import com.toprunner.ubii.toprunner.utils.StepCountModeDispatcher;
import com.toprunner.ubii.toprunner.view.StepArcView;


public class JibuActivity extends AppCompatActivity implements Handler.Callback, View.OnClickListener {
    private TextView tv_data;
    private StepArcView cc;
    private TextView tv_set;
    private TextView tv_isSupport;
    private Handler delayHandler;
    private CacheUtils sp;
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case ConfigUtil.MSG_FROM_SERVER:
                String planWalk_QTY = (String) sp.getParam("planWalk_QTY", "7000");
    ...
    ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            try {
                ...
                Message msg = Message.obtain(null, ConfigUtil.MSG_FROM_CLIENT);
