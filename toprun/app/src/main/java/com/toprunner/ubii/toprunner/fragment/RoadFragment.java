...
public class RoadFragment extends BaseFragment {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        explains.add(new String[]{"没有颜色但是当时的但是当时的速颠三倒四的第三代收到是多色多色的地方而我國畫幅單反", "没有颜色", "蓝色的点\n第二行的文字\n第三行的文字", "没有颜色\n第二行的文字\n第三行的文字\n第四行的文字\n第五行的文字", "没有颜色", "没有颜色", ""});
        ...
        //线图
        View chart = ChartFactory.getLineChartView(UIUtils.getContext(), mXYMultipleSeriesDataset, renderer);
