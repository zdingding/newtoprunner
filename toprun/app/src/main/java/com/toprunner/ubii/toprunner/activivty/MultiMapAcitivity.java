...
public class MultiMapAcitivity extends AppCompatActivity {
    ...
    private static final LatLng GEO_SHENGZHENG = new LatLng(39.906735, 116.399);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_multi_map_acitivity);
        initMap();
    }
